...
export const GeneralInput = ({ data_class }) => (
  <div>
    <div className="form-row">
      ...
      <div className="form-group col-md-3 mx-auto">
        <label htmlFor="left_player_id">Left player aoe2.net id</label>
        <input
          type="number"
          className="form-control"
          id="left_player_id"
      ...
      <div className="form-group col-md-3 center-block civ-div my-auto">
        <input
          type="checkbox"
        ...
        />
        <label htmlFor="exclude_civ_mirrors">Exclude Civ Mirrors</label>
        <br />
        <input
          type="checkbox"
          className="form-check-input"
          ...
          onChange={data_class.handleCheckboxChange}
        />
        <label htmlFor="exclude_opening_mirrors">Exclude Opening Mirrors</label>
      </div>
    </div>
    <div className="form-row">
      <div className="form-check col-md-2">
        <label htmlFor="include_ladder_ids">Ladders</label>
        <Multiselect
          name="include_ladder_ids"
      ...
      <div className="form-check col-md-4">
        <label htmlFor="include_patch_ids">Patches</label>
        <Multiselect
          name="include_patch_ids"
      ...
      <div className="form-check col-md-4">
        <label htmlFor="include_map_ids">Maps</label>
        <Multiselect
          name="include_map_ids"
      ...
      <div className="form-group col-md-2 mx-auto">
        <label htmlFor="num_rows">Row Count</label>
        <input
          type="number"
          className="form-control"
          id="num_rows"
...
export const SubmitButton = ({ data_class }) => (
  <div className="form-row justify-content-center align-self-center">
    <button className="submit-button btn btn-primary" type="submit" disabled={data_class.state.position > -1}>Submit</button>
  </div>
);
  ...
  <div>
    {[...Array(data_class.state.row_count)].map((x, i) => (
      <div className="form-row justify-content-center">
        <div className="form-check col-md-2">
          <label htmlFor={`include_civ_ids_${i * 2}`}>
            {capitalize(stringifyNumber(i + 1))}
            {' '}
            Civ
          </label>
          <Multiselect
            name={`include_civ_ids_${i * 2}`}
        ...
        <div className="form-check col-md-2">
          <label htmlFor={`include_opening_ids_${i * 2}`}>
            {capitalize(stringifyNumber(i + 1))}
            {' '}
            Opening
          </label>
          <Multiselect
            name={`include_opening_ids_${i * 2}`}
        ...
        <div className="form-check col-md-2">
          <label htmlFor={`include_civ_ids_${i * 2 + 1}`}>
            {capitalize(stringifyNumber(i + 1))}
            {' '}
            Enemy Civ
          </label>
          <Multiselect
            name={`include_civ_ids_${i * 2 + 1}`}
            options={data_class.state.info.civs}
            selectionLimit="1"
        ...
        <div className="form-check col-md-2">
          <label htmlFor={`include_opening_ids_${i * 2 + 1}`}>
            {capitalize(stringifyNumber(i + 1))}
            {' '}
            Enemy Opening
          </label>
          <Multiselect
            name={`include_opening_ids_${i * 2 + 1}`}
            options={data_class.state.info.openings}
            selectionLimit="1"
...
export const AdvancedCombinationEntry = ({ data_class }) => (
  <div className="form-row justify-content-center">
    <div className="form-check col-md-2">
      <label htmlFor="include_left_civ_combinations">Left Civilizations</label>
      <Multiselect
        name="include_left_civ_combinations"
        options={data_class.state.info.civs}
    ...
    <div className="form-check col-md-2">
      <label htmlFor="include_left_opening_combinations">Left Openings</label>
      <Multiselect
        name="include_left_opening_combinations"
        options={data_class.state.info.openings}
    ...
    <div className="form-check col-md-2">
      <label htmlFor="include_right_civ_combinations">Right Civilizations</label>
      <Multiselect
        name="include_right_civ_combinations"
        options={data_class.state.info.civs}
    ...
    <div className="form-check col-md-2">
      <label htmlFor="include_right_opening_combinations">Right Openings</label>
      <Multiselect
        name="include_right_opening_combinations"
        options={data_class.state.info.openings}
